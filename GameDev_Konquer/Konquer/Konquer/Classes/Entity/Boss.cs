...
namespace Konquer.Classes.Entity
{
    public class Boss : Enemy
    {
        ...
        //public Rectangle BossCollisionRectangle;

        public int Health;

        public override void Load(ContentManager Content)
        {
            geryonAnimation = new Spritesheet(Content.Load<Texture2D>("nightmare-galloping"), 144, 0.3f, true);
            animationPlayer.PlayAnimation(geryonAnimation);
            //BossCollisionRectangle = new Rectangle((int)Position.X, (int)Position.Y, geryonAnimation.FrameWidth, geryonAnimation.FrameHeight);
        }
